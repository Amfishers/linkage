...
},
{
    ...
    { name: '东莞市', areaList: ['市辖区'] },
    { name: '中山市', areaList: ['市辖区'] },
...
{
    name: '台湾', cityList: [
        { name: '台北市', areaList: ['市辖区'] },
        { name: '新北市', areaList: ['市辖区'] },
        { name: '桃园市', areaList: ['市辖区'] },
        { name: '台中市', areaList: ['市辖区'] },
        { name: '台南市', areaList: ['市辖区'] },
        { name: '高雄市', areaList: ['市辖区'] }
    ]
},
{
    name: '香港', cityList: [
        { name: '香港', areaList: ['中西区', '湾仔区', '东区', '南区', '油尖旺区', '深水埗区', '九龙城区', '黄大仙区', '观塘区', '北区', '大埔区', '沙田区', '西贡区', '荃湾区', '屯门区', '元朗区', '葵青区', '离岛区'] }
    ]
},
{
    name: '澳门', cityList: [
        { name: '澳门', areaList: ['花地玛堂区', '圣安多尼堂区', '大堂区', '望德堂区', '风顺堂区', '嘉模堂区', '圣方济各堂区', '路氹城'] }
    ]
}
];